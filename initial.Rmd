...
ggplot(vb2) +
  geom_bar(aes(x=dig, fill=hit), position="fill") + scale_fill_manual("legend", values = c("kill" = "black", "attempt" = "gold", "error" = "grey"))
...
vb2$hit2 <- factor(vb2$hit, levels = c("error", "attempt", "kill"))
sizes
